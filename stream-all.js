...
[Script]
解锁检测 = type=generic,timeout=30,script-path=https://raw.githubusercontent.com/i-liulang/Surge/main/stream-all.js,script-update-interval=0,argument=title=𝗦𝗧𝗥𝗘𝗔𝗠𝗜𝗡𝗚 𝗖𝗛𝗘𝗖𝗞&icon=4k.tv.fill&color=#E22400
...
(async () => {
  ...
  let panel_result = {
    title: `${args.title} | ${hour}:${minutes}` || `𝗦𝗧𝗥𝗘𝗔𝗠𝗜𝗡𝗚 𝗖𝗛𝗘𝗖𝗞 | ${hour}:${minutes}`,
    content: '',
  ...
  await Promise.all([check_youtube_premium(), check_netflix()])
    .then((result) => {
      ...
      if (status == STATUS_COMING) {
        //console.log(1)
        disney_result = "𝗗+: 即将登陆~" + region.toUpperCase()
      } else if (status == STATUS_AVAILABLE) {
        //console.log(2)
        console.log(region)
        disney_result = "𝗗+: \u2611" + region.toUpperCase()
